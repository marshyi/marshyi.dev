...
export default function NavBar() {
  ...
  return (
    <header className="flex items-center justify-center w-screen fixed top-0 left-0 h-32 sm:landscape:h-20 md:h-24 bg-black z-10 animate-[fadeIn_2s_ease_forwards]">
      <div className="flex flex-row flex-wrap items-center justify-center h-full w-11/12 md:w-10/12 lg:w-7/12 md:justify-between">
        <h1 className="font-mono text-xl sm:pt-5 md:pt-0">
          <Link href="#about" tabIndex={1}>marshyi.dev</Link>
        </h1>
        <nav>
