...
export default function Projects() {
  return (
    <Section title="Projects" tabIndex={7}>
      <div className="flex w-full overflow-x-scroll space-x-6 px-8 mt-8 scroll-smooth sm:landscape:mt-4 sm:landscape:justify-center lg:portrait:justify-start lg:justify-center lg:pt-3 lg:mb-6">
        <div className="group relative flex-none w-3/4 h-fit aspect-video rounded-lg border-2 border-blue-700 sm:landscape:w-1/4 lg:w-96">
          <Link href="" className="flex p-0 blur-[1px] group-hover:blur-none">
            <Image
              ...
              width={1920}
              height={1080}
              className="object-cover w-full h-full brightness-200"
              alt="Project"
            />
            <div className="absolute inset-0 bg-gradient-to-br from-blue-300 via-blue-200 to-blue-300 opacity-70 group-hover:opacity-0 transition-opacity duration-500"></div>
          </Link>
        </div>
        <div className="group relative flex-none w-3/4 h-fit aspect-video rounded-lg border-2 border-blue-700 sm:landscape:w-1/4 lg:w-96">
          <Link href="" className="flex p-0 blur-[1px] group-hover:blur-none">
